...
class $ {
    ...
    async cachePut(e, t) {
        ...
        const { cacheName: c, matchOptions: i } = this._strategy,
            ...
            p = h ? await q(o, n.clone(), ['__WB_REVISION__'], i) : null;
        try {
...
class G {
    ...
    handleAll(e) {
        ...
        const t = e.event,
            ...
            r = new $(this, { event: t, request: s, params: n }),
    ...
    async _handleFetch(e, t) {
        ...
        if (this._fallbackToNetwork) {
            const r = n.integrity,
                c = e.integrity,
                i = !c || c === r;
            (s = await t.fetch(new Request(e, { integrity: c || r }))),
                r &&
                    i &&
...
let w;
const J = () => (
    w || ((w = new z()), w.addFetchListener(), w.addCacheListener()), w
);
function N(a, e, t) {
    let s;
    if (typeof a == 'string') {
...
const te = '-precache-',
    se = async (a, e = te) => {
        const s = (await self.caches.keys()).filter(
            (n) =>
                n.includes(e) && n.includes(self.registration.scope) && n !== a,
        );
...
class ie extends g {
    constructor(e, { allowlist: t = [/./], denylist: s = [] } = {}) {
        super((n) => this._match(n), e);
        (this._allowlist = t), (this._denylist = s);
    }
...
ce([
    { revision: null, url: 'assets/abc.80256bc9.js' },
    { revision: null, url: 'assets/_name_.86ed49ca.js' },
    { revision: null, url: 'assets/404.8a8df44a.js' },
    { revision: null, url: 'assets/about.3d1d4908.js' },
    { revision: null, url: 'assets/index.91670525.js' },
    { revision: null, url: 'assets/index.9da6c8cb.css' },
    { revision: null, url: 'assets/vendor.68a93192.js' },
    { revision: '5e86923ef16ac53724de8fc7aac1305c', url: 'index.html' },
    { revision: 'e80262db12c836cdca2b94a688576107', url: 'sw.js' },
    { revision: '71dcfd191507c31dc79efe3341dfa3b9', url: 'favicon.svg' },
    { revision: 'f24c9384006bbc8de95ed69990459dca', url: 'pwa-192x192.png' },
    { revision: '4db5b8fe442a8f8fdc6e35cd40138057', url: 'pwa-512x512.png' },
    {
        revision: '762ef52e7e5cd94f048934010d9078e0',
